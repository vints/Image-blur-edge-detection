...
public class RunIterator implements Iterator {
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
      int[] runProperties = new int[4];
      runProperties[0] = currentRun.item.len;
      runProperties[1] = currentRun.item.r;
      runProperties[2] = currentRun.item.g;
      runProperties[3] = currentRun.item.b;
